                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ route("contactHtmlTR") }}" title="İletişim">İlatişim</a>
                            </li>
                            <li>
                                <a href="" title="İngilizce"><img src="{{ asset("asset/usa.svg") }}" width="30" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
