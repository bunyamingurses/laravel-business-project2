                            ...
                            <div class="service-list">
                                <ul>
                                    ...
                                    @foreach($popular as $popularWrite)
                                        <li>
                                            <a href="{{ route("productDetailHtmlTR",["id"=>$popularWrite->id,"name"=>\App\Http\Controllers\support\functionController::seo($popularWrite->titleEnglish)]) }}"
                                               class="sec-btn" title="All Maintenance">{{ $popularWrite->titleEnglish }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                                                ...
                                                <a href="{{ asset("imageAvif/product/gallery/")."/".$galleryWrite->imageAvif }} "
                                                   ...
                                                   title="Gallery Image">
                                                    <div class="back-img"
                                                        ...
                                                        <h4 class="text-center text-light" style="padding-top:45%;">{{ $galleryWrite->nameEnglish }}</h4>
                                                    </div>
                                                </a>
                                            </li>
                                        @endforeach
